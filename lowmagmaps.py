...
# lowmagmaps.py - (C) 2017 Martin Schorb EMBL
#
...
# - the navigator label of the original map
# - the navigator labels of the desired points (as a list)
...
target_map = 'refmap'
# one example map at the desired settings
...
#            %matplotlib inline
        ...
        #    print(points[i])
            ...
            c1 = a*rotmat * targetheader['pixelsize'] + pt
          ...
          # fill navigator  
           ...
           # newnavitem['MapWidthHeight'] = [str(im2size[0]),str(im2size[1])]
            ...
            outnav = itemtonav(newnavitem,'map_' + str(i))
